...
```{r}
dir_plot <- lollipop_dir(merged_data)
dir_plot
```

This table show the top 20 highest ranked movies and TV shows, based on their IMDB score, as well as the director. The information presented here indicates that these directors have produced some of the most loved and critically acclaimed shows and it would, therefore, be a good idea to consider these directors when choosing which movies and TV shows to stream.
